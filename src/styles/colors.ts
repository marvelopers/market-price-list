export const GREY_1 = '#1E293B';
export const GREY_2 = '#334155';
export const GREY_3 = '#64748B';
...
export const WHITE_BACKGROUND_RGB = 'rgba(255, 255, 255, 0.4)';

export const KORBIT_RED = '#DC2626';
export const KORBIT_BLUE = '#2563EB';
export const KORBIT_SKY_BLUE = '#0EA5E9';
export const KORBIT_YELLOW = '#FFC10D';
